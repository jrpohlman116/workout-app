      ...
      <div className="max-w-md mx-auto px-4 py-6">
        {activeTab === '1rm' && (
          <div className="space-y-4 animate-enter">
            <Card className="p-6">
              <h3 className="text-h3 text-gray-900 dark:text-gray-100 mb-2">1 Rep Max</h3>
        ...
        {activeTab === 'wilks' && (
          <div className="space-y-4 animate-enter">
            <Card className="p-6">
              <h3 className="text-h3 text-gray-900 dark:text-gray-100 mb-2">Wilks Score</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-6">
        ...
        {activeTab === 'plates' && (
          <div className="space-y-4 animate-enter">
            <Card className="p-6">
              <h3 className="text-h3 text-gray-900 dark:text-gray-100 mb-2">Plate Calculator</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-6">
